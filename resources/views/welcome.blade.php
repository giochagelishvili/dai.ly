        ...
        <div class="w-full h-full px-4 py-4">
            <div class="w-full h-full flex flex-col items-center justify-evenly gap-6 border border-black p-4">
                ...
                <div>
                    ...
                    <a href="{{ route('authentication') }}" class="flex items-center justify-between bg-black text-white py-2 px-6 mt-4 font-gothic text-lg rounded-lg">
                        Get Started
                ...
                <div>
                    <p class="opacity-60 text-xl">
                        ...
                        <a href="{{ route('authentication') }}" class="underline">Sign In</a>
                    </p>
                </div>
            </div>
        </div>
